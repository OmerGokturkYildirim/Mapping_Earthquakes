...
// Creating earthquake and tectnoic plate layers 
let earthquakes = new L.layerGroup();
let tectonicPlates = L.layerGroup();


// Defining an object which contains the overlays.
let overlays = {
...
d3.json(earthquakeData).then(function(data) {
    ...
    // Returning the style data for earthquakes
    ...
    L.geoJson(data, {
        ...
        // Creating a popup for each circleMarker 
    ...
    legend.onAdd = function () {
        ...
        // Looping intervals to generate a label
...
d3.json(tectonicData).then(function(data) {
    ...
    L.geoJson(data, {
        ...
        onEachFeature: function(feature, layer) {
            layer.bindPopup(
                "<h2>Name: " + feature.properties.PlateA + "-" + feature.properties.PlateB + "</h2>"+ "<hr>" +
                "<h3> Plate Source: " + feature.properties.Source + "</h3>"
            );
        }
